...
class IAGui:
	...
	def browseFiles(self):
		...
		if self.filename:
			...
			dataTypeLabel.grid(row=4, column=1, sticky=NE)
			Label(window, text="Product").grid(row=5, column=1,sticky=E)
			Label(window, text="(Additional Product Info)").grid(row=6,column=1,sticky=E)
			Label(window, text="(Additional Product Info)").grid(row=7,column=1,sticky=NE)
			Label(window, text="Facility").grid(row=8, column=1, sticky=E)
			Label(window, text="(Additional Facility Info)").grid(row=9,column=1,sticky=E)
			Label(window, text="(Additional Facility Info)").grid(row=10,column=1,sticky=NE)
			Label(window, text="Date Field").grid(row=11, column=1, sticky=E)
			Label(window, text="Consumption Field").grid(row=12, column=1, sticky=E)
			Label(window, text="Stock on Hand Field").grid(row=13, column=1, sticky=NE)
			Label(window, text="Time Window for Rates").grid(row=14, column=1, sticky=E)
			...
			ttk.Combobox(window, textvariable=self.issue_col, values=self.column_names,
				  justify=LEFT).grid(row=12,column=2, padx=(0,5))
			Radiobutton(window,text="Blank fields = 0",variable=self.issue_0,value=1).grid(row=12,column=3,sticky=W,padx=(0,5))
			Radiobutton(window,text="Blank fields are missing",variable=self.issue_0,value=0).grid(row=12,column=4,sticky=W,padx=(0,5))
			ttk.Combobox(window, textvariable=self.soh_col, values=self.column_names,
				  justify=LEFT).grid(row=13,column=2, padx=(0,5),pady=(0,50))
			Radiobutton(window,text="Blank fields = 0",variable=self.soh_0,value=1).grid(row=13,column=3,sticky=W,padx=(0,5),pady=(0,50))
			Radiobutton(window,text="Blank fields are missing",variable=self.soh_0,value=0).grid(row=13,column=4,sticky=W,padx=(0,5),pady=(0,50))
	...
	def openReport(self):
		...
		os.system("start excel.exe ..\LMIS_Analysis_Report.xlsm")
